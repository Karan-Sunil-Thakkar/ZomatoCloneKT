...
import FontAwsome6 from 'react-native-vector-icons/dist/FontAwesome6';
  ...
  return (
    <View style={style}>
      {type === 'MaterialCommunityIcons' ? (
        ...
        <FontAwsome onPress={onPress} name={name} size={size} color={color} />
      ) : type === 'FontAwsome5' ? (
        <FontAwsome5 onPress={onPress} name={name} size={size} color={color} />
      ) : type === 'FontAwsome6' ? (
        <FontAwsome6 onPress={onPress} name={name} size={size} color={color} />
      ) : type === 'Feather' ? (
